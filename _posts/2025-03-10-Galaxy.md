...
1. **Galaxy Interface**: Screenshot with Tools/History annotations.
2. **FASTQ Breakdown**: Diagram of FASTQ entry with labels.
3. **Pipeline Flow**: Flowchart from FASTQ to interpretation.
4. **IGV View**: Alignment with variant highlighted.
5. **Annotation Table**: Excel screenshot with filters.

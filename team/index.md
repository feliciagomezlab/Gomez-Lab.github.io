...
<div style="display: flex; flex-direction: row; align-items: flex-start; gap: 30px; margin-bottom: 40px;">
  ...
  <div style="max-width: 700px;">
    ...
    <p><strong>Graduate Student, Griffith Lab</strong></p>
    <p>Mariam Khanfar is a PhD candidate in the Griffith lab at Washington University in St. Louis. She collaborates with the Gomez lab on studies of Hodgkin lymphoma and the tumor microenvironment, applying genomic and RNA technologies such as whole-exome sequencing and single-cell genomics to advance cancer research and improve understanding of tumor–immune interactions.</p>
    <div style="margin-top: 10px;">
